...
def upload_night(night_dir, camsid, sequenceid=1):
    ...
    with ftplib.FTP(host=FTPSITE, user=FTPUSER, passwd=FTPPASSWORD) as ftp:
        ...
        with open(zipfilepath, "rb") as zf:
            ...
            logging.info(f'{zipfilename} succesfully uploaded ! ')
...
if __name__ == "__main__":
    logging.basicConfig(
        ...
        handlers=[logging.StreamHandler(),
                  logging.FileHandler("/home/pi/RMS_data/logs/autormscams_upload_log/autormscams_upload_log.log")]
    )
